...
'''
Return the above pauling electronegativity data as a machine-readable dictionary
'''
...
'''
Create a matrix of electronegativity differences between the first `num_elements` elements
'''
def get_eleneg_diff_mat(num_elements=100):
    # Creation of relative electronegativity matrix
    paulingdata = give_paulingdata()
